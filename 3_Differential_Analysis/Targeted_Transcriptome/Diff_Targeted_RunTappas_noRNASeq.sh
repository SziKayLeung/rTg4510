...
cd $DiffAnalysis_WKD; mkdir -p TAPPAS_OUTPUT TAPPAS_INPUT
...
# File 2
cp $DiffAnalysis_WKD/SQANTI3/$dataset"_ISMrem.Targetisoform.txt" $DiffAnalysis_WKD/TAPPAS_INPUT

# File 3
Rscript $GENERALFUNC/Whole_Prepare_Counts.R $DiffAnalysis_WKD/SQANTI3/$dataset".collapsed_classification.filtered_lite_classification.txt" $DiffAnalysis_WKD/TAPPAS_INPUT/IsoSeq_Expression/$dataset"_expression.txt"
...
scp -r sl693@login.isca.ex.ac.uk:/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/IsoSeq/Targeted_Transcriptome/Mouse/DiffAnalysis_noRNASEQ/TAPPAS_INPUT/* /mnt/data1/Szi/TAPPAS_FINAL_MOUSE/MouseTargeted/
/mnt/data1/Aaron/sw/jre1.8.0_181/bin/java -jar /mnt/data1/Szi/tappAS.jar

#### Tappas output
### tappAS projects
# Project.0561121014.tappas = Targeted Mouse + IsoSeq (All Trancripts for Input Expression)
scp -r sLeung@knight.ex.ac.uk:/mnt/data1/Szi/tappasWorkspace/Projects/Project.0561121014.tappas/* $DiffAnalysis_WKD/TAPPAS_OUTPUT/IsoSeq_Expression/
