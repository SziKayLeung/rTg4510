...
---
AD mouse model, age: Tg4510, 6months (Baseline)
Phenotype: WT
...
# validation
head(MCount_all[which(MCount_all$Genes == "Arf3"),])
...
write.csv(MCount_all,file = '/mnt/data1/Szi/Q21/Comparisons_RNAseq/MergeCount_allIsoforms.csv')
```
...
# MCount_all <- read.csv("//isad.isadroot.ex.ac.uk/UOE/User/My Documents/PacBio/AD_Mouse_Tg4510/2 months/Q21/MergeCount_allIsoforms.csv", header = TRUE)
# Before plotting correlation, want to detect the genes that are detected by RNAseq and not by PacBio and vice-versa 
# ensure working with dataframe 
...
write.csv(MCount_all,file = '/mnt/data1/Szi/Q21/Comparisons_RNAseq/MergeCount_allIsoforms_Detection.csv')
