---
title: "RNASeqvsIsoSeq of Sample `r params$Sample`"
...
source("/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/Scripts/IsoSeq3_Tg4510/RNASeqvsIsoSeq/RNASeqvsIsoSeq.R")
...
```{r, echo = TRUE}
sqanti_dir <- "/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/WholeTranscriptome/Individual/Isoseq3.2.1/SQANTI2_v7"
SQANTI_input(sample, sqanti_dir)
```
...
```{r, echo = TRUE}
tofu_dir <- "/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/WholeTranscriptome/Individual/Isoseq3.2.1/TOFU"
TOFU_input(sample, tofu_dir)
...
Merge_IsoSeq[which(is.na(Merge_IsoSeq$norm_fl)),]
...
gencode <- read.table("/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/reference_2019/gencode.vM22_gene_annotation_table.txt", sep="\t")
