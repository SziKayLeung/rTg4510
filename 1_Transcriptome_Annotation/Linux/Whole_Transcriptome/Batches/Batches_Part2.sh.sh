...
SQANTI2_DIR=/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/softwares/Post_Isoseq3/SQANTI2
CUPCAKE_SEQUENCE=/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/softwares/Post_Isoseq3/cDNA_Cupcake/sequence
python $SQANTI2_DIR/sqanti_filter2.py all_samples.chained.rep_classification.txt all_samples.chained.rep_corrected.fasta all_samples.chained.rep_corrected.gtf -a 0.6 -c 3

cd /gpfs/mrc0/projects/Research_Project-MRC148213/sl693/WholeTranscriptome/Tg4510/CHAINED_ANALYIS/mm10/SQANTI2
python $SQANTI3_DIR/sqanti3_qc.py --gtf ../all_samples.chained.gff $REFERENCE/gencode.vM22.annotation.gtf $REFERENCE/mm10.fa -fl ../all_samples.chained_count.txt
...
python $SQANTI3_DIR/sqanti3_qc.py --gtf ../all_samples.chained.gff $REFERENCE/gencode.vM22.annotation.gtf $REFERENCE/mm10.fa --fl_count ../all_samples.chained_count.txt --skipORF
...
cd /gpfs/mrc0/projects/Research_Project-MRC148213/sl693/IsoSeq/Whole_Transcriptome/Individual_Samples_OLD/CHAIN/SQANTI3
python $SQANTI3_DIR/sqanti3_qc.py -t 30 --gtf ../all_samples.chained.gff $REFERENCE/gencode.vM22.annotation.gtf $REFERENCE/mm10.fa --fl_count ../all_samples.chained_count.txt --skipORF
