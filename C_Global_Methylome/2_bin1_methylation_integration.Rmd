...
source(paste0(SC_ROOT,"C_Global_Methylome/01_source_functions.R"))
...
# Config files 
source(paste0(SC_ROOT,"B_Targeted_Transcriptome/3_Differential_Analysis/A_tappAS/rTg4510_differential.config.R"))
source(paste0(SC_ROOT,"C_Global_Methylome/rTg4510_methylation.config.R"))

# Bin1 charcterisation files (generated for Thesis)
bin1_stats = "/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/rTg4510/G_Merged_Targeted/A_talon_pipeline/4_characterise/TargetGenes/Filtered/Bin1/Stats"
...
annotated <- list(
  iso = annotate_tappasfiles(input.class.files$iso,loaded$iso$input_normalized_matrix,misc_input$iso),
  ont = annotate_tappasfiles(input.class.files$ont,loaded$ont$input_normalized_matrix,misc_input$ont)
)
...
## Details
- position of BIN1 DMP: chr18:32431597
- position of BIN1 exon skipped: chr18:32431671-32431742
- BIN1 isoform upregulated: ENSMUST00000234496.1
...
```{r function_plot, message=FALSE}

subset_DMP <- function(age){
