...
#SBATCH --output=Differential_Analysis_RNASeq_Prepare-%A_%a.o
#SBATCH --error=Differential_Analysis_RNASeq_Prepare-%A_%a.e
...
run_kallisto_1sample ${RNASEQ_FILTERED_DIR} ${SAMPLE} AllRNASeq_Kallisto.idx $WKD_ROOT/2_post_isoseq3/10_rnaseq2isoseq